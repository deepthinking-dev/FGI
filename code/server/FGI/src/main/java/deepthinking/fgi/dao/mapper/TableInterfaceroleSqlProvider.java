...
public class TableInterfaceroleSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(TableInterfaceroleCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("table_interfacerole");
     ...
     * @mbg.generated
     */
    public String deleteByExample(TableInterfaceroleCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("table_interfacerole");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(TableInterfacerole record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("table_interfacerole");
     ...
     * @mbg.generated
     */
    public String selectByExample(TableInterfaceroleCriteria example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("ParametersID");
        sql.SELECT("PreInterfaceID");
        sql.SELECT("PreParametersID");
        sql.SELECT("Des");
        sql.SELECT("Remark");
        sql.FROM("table_interfacerole");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TableInterfacerole record = (TableInterfacerole) parameter.get("record");
        TableInterfaceroleCriteria example = (TableInterfaceroleCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("table_interfacerole");
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(TableInterfacerole record) {
        SQL sql = new SQL();
        sql.UPDATE("table_interfacerole");
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, TableInterfaceroleCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
