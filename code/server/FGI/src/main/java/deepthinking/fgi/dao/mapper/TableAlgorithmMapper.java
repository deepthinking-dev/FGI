...
public interface TableAlgorithmMapper {
     ...
     * @mbg.generated
     */
    @SelectProvider(type=TableAlgorithmSqlProvider.class, method="selectByExampleWithBLOBs")
    @Results({
        ...
        @Result(column="Remark2", property="remark2", jdbcType=JdbcType.LONGVARCHAR)
    })
    List<TableAlgorithm> selectByExampleWithBLOBs(TableAlgorithmCriteria example);
    ...
    @Select({
        ...
        "UserID, AlgorithmGroup, Remark, Status, Remark3, Remark4, Remark2",
     ...
     * @mbg.generated
     */
    @UpdateProvider(type=TableAlgorithmSqlProvider.class, method="updateByExampleWithBLOBs")
    int updateByExampleWithBLOBs(@Param("record") TableAlgorithm record, @Param("example") TableAlgorithmCriteria example);
    ...
    int updateByPrimaryKeyWithBLOBs(TableAlgorithm record);
    ...
    @Select({
            "select",
            "ID, AlgorithmName,Status,AlgorithmAuthor,Des,Remark3",
            "from table_algorithm where Status = #{status}"
    })
    @Results({
            @Result(column="ID", property="id", jdbcType=JdbcType.INTEGER, id=true),
            @Result(column="AlgorithmName", property="algorithmname", jdbcType=JdbcType.VARCHAR),
            ...
            @Result(column="AlgorithmAuthor", property="algorithmauthor", jdbcType=JdbcType.VARCHAR),
            @Result(column="Des", property="des", jdbcType=JdbcType.VARCHAR),
            @Result(column="Remark3", property="dataurl", jdbcType=JdbcType.VARCHAR)
    })
