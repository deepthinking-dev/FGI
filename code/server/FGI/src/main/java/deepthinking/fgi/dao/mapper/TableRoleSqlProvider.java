...
public class TableRoleSqlProvider {
    ...
    public String insertSelective(TableRole record) {
        ...
        if (record.getCoordinate() != null) {
            sql.VALUES("coordinate", "#{coordinate,jdbcType=LONGVARCHAR}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExampleWithBLOBs(TableRoleCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByPrimaryKeySelective(TableRole record) {
        ...
        if (record.getCoordinate() != null) {
            sql.SET("coordinate = #{coordinate,jdbcType=LONGVARCHAR}");
        }
