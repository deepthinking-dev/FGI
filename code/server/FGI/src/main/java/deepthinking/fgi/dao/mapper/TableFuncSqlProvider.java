...
public class TableFuncSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(TableFuncCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("table_func");
     ...
     * @mbg.generated
     */
    public String deleteByExample(TableFuncCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("table_func");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(TableFunc record) {
        SQL sql = new SQL();
        ...
        if (record.getVarname() != null) {
            sql.VALUES("VarName", "#{varname,jdbcType=VARCHAR}");
        }
        
        if (record.getVartype() != null) {
            sql.VALUES("VarType", "#{vartype,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExample(TableFuncCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TableFunc record = (TableFunc) parameter.get("record");
    ...
    public String updateByPrimaryKeySelective(TableFunc record) {
        ...
        if (record.getVarname() != null) {
            sql.SET("VarName = #{varname,jdbcType=VARCHAR}");
        }
        
        if (record.getVartype() != null) {
            sql.SET("VarType = #{vartype,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, TableFuncCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
